...
public interface SalesTransactionRepository extends JpaRepository<SalesTransactionEntity, Long> {
        ...
        List<SalesTransactionEntity> findByTransactionDateBetween(@Param("startDate") String startDate,
         ...
         */
        List<SalesTransactionEntity> findByPartyId(Long partyId);
        ...
        BigDecimal getTotalSalesForDateRange(@Param("startDate") String startDate,
                        @Param("endDate") String endDate);
        ...
        BigDecimal getTotalReceivedForDateRange(@Param("startDate") String startDate,
                        @Param("endDate") String endDate);
        ...
        BigDecimal getTotalBalanceForDateRange(@Param("startDate") String startDate,
                        @Param("endDate") String endDate);
         ...
         */
        @Query("SELECT st.partyId, st.partyName, SUM(st.netAmount) as totalAmount FROM SalesTransactionEntity st WHERE st.transactionType = 'SALE' AND st.status = 'COMPLETED' GROUP BY st.partyId, st.partyName ORDER BY totalAmount DESC")
        ...
        List<Object[]> getDailySalesSummary(@Param("startDate") String startDate,
                        @Param("endDate") String endDate);
         ...
         */
        List<SalesTransactionEntity> findByCreatedAtBetween(String startDate, String endDate);
        ...
        @Query(value = """
                        ...
                        WHERE st.transaction_date BETWEEN :startDate AND :endDate
                          ...
                          AND st.status = 'COMPLETED'
                        """, nativeQuery = true)
        BigDecimal getLastMonthTotalReceived(@Param("startDate") String startDate,
                        @Param("endDate") String endDate);
        ...
        @Query(value = """
                        ...
                        WHERE st.transaction_date BETWEEN :startDate AND :endDate
                          ...
                          AND st.status = 'COMPLETED'
                        """, nativeQuery = true)
        BigDecimal getLastMonthTotalBalance(@Param("startDate") String startDate,
                        @Param("endDate") String endDate);
}
