...
public interface ProformaInvoiceTransactionRepository extends JpaRepository<ProformaInvoiceTransactionEntity, Long> {
    ...
    BigDecimal getTotalProformaInvoiceAmountForDateRange(@Param("startDate") LocalDate startDate,
    ...
    List<ProformaInvoiceTransactionEntity> findByTransactionDateBetween(@Param("startDate") LocalDate startDate,
            @Param("endDate") LocalDate endDate);
