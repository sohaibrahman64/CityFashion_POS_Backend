...
public interface EstimateQuotationTransactionRepository
  ...
  BigDecimal getTotalEstimateQuotationAmountForDateRange(@Param("startDate") String startDate,
  ...
  List<EstimateQuotationTransactionEntity> findByTransactionDateBetween(@Param("startDate") String startDate,
      @Param("endDate") String endDate);
