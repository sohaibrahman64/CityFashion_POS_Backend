...
@Entity
@Table(name = "new_sales_order_item")
public class NewSalesOrderItemEntity {
    @Id
    @GeneratedValue(strategy = javax.persistence.GenerationType.IDENTITY)
    private Long id;

    @Column(name = "sales_order_id")
    private Long salesOrderId; // Reference to EstimateQuotation
    ...
    public void setSalesOrderId(Long proformaInvoiceId) {
        this.salesOrderId = proformaInvoiceId;
    }
