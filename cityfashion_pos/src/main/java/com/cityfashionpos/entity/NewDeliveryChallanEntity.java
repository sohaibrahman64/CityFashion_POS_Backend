...
@Entity
@Table(name = "new_delivery_challan")
public class NewDeliveryChallanEntity {
    @Id
    ...
    public void setDeliveryChallanNumber(String proformaInvoiceNumber) {
        this.deliveryChallanNumber = proformaInvoiceNumber;
    }
    ...
    public void setDeliveryChallanInvoiceDate(String proformaInvoiceDate) {
        this.deliveryChallanInvoiceDate = proformaInvoiceDate;
    }
