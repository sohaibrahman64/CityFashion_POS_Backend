...
public class EstimateQuotationTransactionServiceImpl implements EstimateQuotationTransactionService {
        ...
        private EstimateQuotationTransactionResponse mapEntityToResponse(EstimateQuotationTransactionEntity entity,
                ...
                EstimateQuotationTransactionResponse response = new EstimateQuotationTransactionResponse(success,
                                message);
        ...
        @Override
        public Map<String, BigDecimal> getTotalEstimateQuotationAmountsByDateRange(LocalDate fromDate,
                        LocalDate toDate) {
                try {
                        BigDecimal totalEstimateQuotationAmount = estimateQuotationTransactionRepository
                                        .getTotalEstimateQuotationAmountForDateRange(fromDate.toString(),
                                                        toDate.toString());
                        BigDecimal totalOpenAmount = estimateQuotationTransactionRepository
                        ...
                        totalEstimateQuotationAmount = totalEstimateQuotationAmount != null
                        ...
                        BigDecimal lastMonthEstimateQuotationAmount = estimateQuotationTransactionRepository
                                        .getTotalEstimateQuotationAmountForDateRange(firstDayLastMonth.toString(),
                                                        lastDayLastMonth.toString());
                        BigDecimal lastMonthOpenAmount = estimateQuotationTransactionRepository
                        ...
                        BigDecimal lastMonthTotalEstimateQuotationAmount = lastMonthOpenAmount
                        ...
                        logger.info("Date range totals from {} to {}: Sales: {}, Received: {}, Balance: {}",
                                        fromDate, toDate, totalEstimateQuotationAmount, totalOpenAmount,
        ...
        public Map<String, BigDecimal> getTotalOpenAndConvertedAmounts() {
                try {
                        ...
                        BigDecimal lastMonthTotalOpenAmount = estimateQuotationTransactionRepository
        ...
        public List<EstimateQuotationTransactionResponse> getEstimateQuotationTransactionByDateRange(LocalDate fromDate,
                        LocalDate toDate) {
                try {
                        logger.info("Fetching estimate quotation transaction records for date range: {} to {}",
                                        fromDate, toDate);
                        ...
                        List<EstimateQuotationTransactionResponse> estimateQuotationTransactionRecords = transactions
                                        .stream()
