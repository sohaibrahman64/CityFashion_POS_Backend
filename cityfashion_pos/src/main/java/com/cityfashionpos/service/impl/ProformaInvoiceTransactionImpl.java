...
public class ProformaInvoiceTransactionImpl implements ProformaInvoiceTransactionService {
    ...
    public Map<String, BigDecimal> getTotalProformaInvoiceAmountsByDateRange(LocalDate fromDate, LocalDate toDate) {
        try {
            BigDecimal totalProformaInvoiceAmount = proformaInvoiceTransactionRepository
                    .getTotalProformaInvoiceAmountForDateRange(fromDate, toDate);
            BigDecimal totalOpenAmount = proformaInvoiceTransactionRepository.getTotalOpenAmountForDateRange(fromDate,
                    toDate);
            ...
            BigDecimal lastMonthProformaInvoiceAmount = proformaInvoiceTransactionRepository
                    .getTotalProformaInvoiceAmountForDateRange(firstDayLastMonth,
                            lastDayLastMonth);
            BigDecimal lastMonthOpenAmount = proformaInvoiceTransactionRepository.getTotalOpenAmountForDateRange(
                    firstDayLastMonth,
                    lastDayLastMonth);
            ...
            BigDecimal lastMonthTotalProformaInvoiceAmount = lastMonthOpenAmount.add(lastMonthConvertedAmount);
            ...
            logger.info("Date range totals from {} to {}: Total: {}, Open: {}, Converted: {}",
                    fromDate, toDate, totalProformaInvoiceAmount, totalOpenAmount, totalConvertedAmount);
            return totals;
        } catch (Exception e) {
    ...
    public Map<String, BigDecimal> getTotalOpenAndConvertedAmounts() {
        try {
            ...
            BigDecimal totalConvertedAmount = proformaInvoiceTransactionRepository.getTotalConvertedAmount();
            ...
            BigDecimal lastMonthTotalOpenAmount = proformaInvoiceTransactionRepository.getLastMonthTotalOpenAmount(
                    firstDayLastMonth,
                    lastDayLastMonth);
    ...
    public List<ProformaInvoiceTransactionResponse> getProformaInvoiceTransactionByDateRange(LocalDate fromDate,
            LocalDate toDate) {
        try {
            logger.info("Fetching proforma invoice transaction records for date range: {} to {}", fromDate, toDate);
            ...
            List<ProformaInvoiceTransactionResponse> proformaInvoiceTransactionRecords = transactions.stream()
