...
public class SalesOrderTransactionResponse {
    private Long id;
    ...
    public SalesOrderTransactionResponse() {

    }

    public SalesOrderTransactionResponse(boolean success, String message) {
    ...
    public void setSalesOrderTransactionNumber(String transactionNumber) {
        this.salesOrderTransactionNumber = transactionNumber;
    }
