...
public class NewSalesOrderRequest {
    ...
    private List<NewSalesOrderItemRequest> items;
    ...
    public static class NewSalesOrderItemRequest {
        private Long id;
    ...
    public List<NewSalesOrderItemRequest> getItems() {
        return items;
    }

    public void setItems(List<NewSalesOrderItemRequest> items) {
        this.items = items;
    }
