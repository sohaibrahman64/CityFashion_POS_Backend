...
public class NewDeliveryChallanRequest {
    private Long partyId;
    private String partyName;
    private String partyPhone;
    private List<NewDeliveryChallanItemRequest> items;
    ...
    public static class NewDeliveryChallanItemRequest {
        private Long id;
    ...
    public List<NewDeliveryChallanItemRequest> getItems() {
        return items;
    }

    public void setItems(List<NewDeliveryChallanItemRequest> items) {
        this.items = items;
    }
    ...
    public void setDeliveryChallanInvoiceDate(LocalDate invoiceDate) {
        this.deliveryChallanInvoiceDate = invoiceDate;
    }
    ...
    public void setDeliveryChallanDueDate(LocalDate dueDate) {
        this.deliveryChallanDueDate = dueDate;
    }
